  ...
  const blogPosts = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1541696456191-068acf3414c7?q=80&w=1528&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      excerpt:
        "Discover lesser-known travel destinations that offer unique experiences and breathtaking views.",
      link: "#",
    },
    {
      ...
      excerpt:
        "Make sure you're prepared for any journey with our comprehensive packing guide.",
      link: "#",
    },
    {
      ...
      excerpt:
        "Plan your next trip with our list of the most exciting travel destinations for the upcoming year.",
      link: "#",
    },
  ];
    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center">
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-4 uppercase">
            The Blog
          </h1>
      ...
      <div className="px-4 py-8">
        <div className="mb-8 text-center">
          ...
          <p className="text-lg text-gray-600">
            Explore our latest travel articles and tips to help you plan your
            next adventure. From hidden gems and essential packing tips to top
            destinations for the year, we have everything you need to make your
